...
class RestaurantTest {
    ...
    public void when_names_of_items_are_given_it_should_return_total_order_value() {
        int totalOrderValue_1 = restaurant.orderValue("Sweet corn soup");
        int totalOrderValue_2 = restaurant.orderValue("Sweet corn soup", "Vegetable lasagne");

        assertThat(totalOrderValue_1, equalTo(119));
        assertThat(totalOrderValue_2, equalTo(388));
